...
class BayesianLearnerHS:
    ...
    # TODO: the convergence of the computed belief is highly related to the design of alpha(reward rescaling param), gamma(forgeting rate) and dropout(memory window)
...
if __name__ == '__main__':
    goal_set = {'g1':(0.9, 0.3265, 0.7825), 'g2':(0.9, -0.3265, 0.7825), 'g3':(1.3, -0.1265, 0.7825)}
    init_s = ((0, 0, 0.7825), 1.57)
    learner = BayesianLearnerHS(goal_set, init_s)
    traj = [((0, 0.11, 0.7825), 1.57),
            ((0, 0.11, 0.7825), 1.57),
            ((0, 0.11, 0.7825), 1.57),
            ((0, 0.11, 0.7825), 1.57),
            ((0, 0.11, 0.7825), 1.57),
            ...
            ((0, 1.62, 0.7825), 1.57),
            ((0, 1.78, 0.7825), 1.57),
            ((0.1, 1.78, 0.7825), 1.57),
            ((0.2, 1.78, 0.7825), 1.57),
            ((1.3, 1.78, 0.7825), 1.57),
            ((1.4, 1.78, 0.7825), 1.57),
            ((1.5, 1.78, 0.7825), 1.57),
            ((1.6, 1.78, 0.7825), 1.57),
            ((1.9, 1.78, 0.7825), 1.57),
            ((2.5, 1.78, 0.7825), 1.57)]
